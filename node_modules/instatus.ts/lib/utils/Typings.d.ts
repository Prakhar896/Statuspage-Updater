...
export declare type PageStatus = 'UP' | 'HASISSUES';
export declare type ComponentStatus = 'OPERATIONAL' | 'UNDERMAINTENANCE' | 'DEGRADEDPERFORMANCE' | 'PARTIALOUTAGE' | 'MINOROUTAGE' | 'MAJOROUTAGE';
export declare type IncidentStatus = 'INVESTIGATING' | 'IDENTIFIED' | 'MONITORING' | 'RESOLVED';
